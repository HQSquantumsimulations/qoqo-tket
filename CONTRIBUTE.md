...
Please fill and sign the CLA found in this repository and send it to info@quantumsimulations.de.
...
3. Linting: We use `flake8 ./src/qoqo_tket`, `mypy ./src/qoqo_tket` to lint all Python code.
